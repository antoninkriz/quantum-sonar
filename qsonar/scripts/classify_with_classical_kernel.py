...
if len(sys.argv) != 3:
	print("Usage: python3 classify_with_classical_kernel.py <n_qubits> <depth>")
	sys.exit(1)
...
directories = ProjectDirectories(working_dir, results_dir="results/classical_kernel/")

# Construct output file name for the saving the results based on script parameters
output_file_name = f"svm_{train_size}_train_{test_size}_test_{n_qubits}_qubits_{depth}_depth.txt"
